...
completion_stats <- read.csv("completion_stats_by_date-DougMOE.csv", 
...
p1 <- ggplot(df_test_time, aes(x = Date, y = Percentage)) +
  ...
  labs(title = "Low Total Test Time Percentage", x = "Date", y = "Percentage") +
...
p2 <- ggplot(df_writing_time, aes(x = Date, y = Percentage)) +
  ...
  labs(title = "Low Writing Time Percentage", x = "Date", y = "Percentage") +
  scale_y_continuous(limits = c(0, 1)) +
  theme_minimal()
...
p3 <- ggplot(df_writing_words, aes(x = Date, y = Percentage)) +
  ...
  labs(title = "Low Word Count Percentage", x = "Date", y = "Percentage") +
  scale_y_continuous(limits = c(0, 1)) +
  theme_minimal()
